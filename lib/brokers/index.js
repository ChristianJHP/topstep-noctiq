...
function createProjectXClient(accountConfig, brokerName, brokerType) {
  ...
  return {
    ...
    async placeBracketOrder(action, stopPrice, tpPrice, quantity = 1, options = {}) {
      ...
      console.log(`[${brokerName}] Placing bracket order: ${action.toUpperCase()}, Stop: ${stopPrice}, TP: ${tpPrice}, skipCleanup: ${skipCleanup}`);
      ...
      console.log(`[${brokerName}] Step 5: Placing take profit at ${tpPrice}...`);
      let tpOrder;
      try {
