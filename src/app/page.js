    ...
    <div className="min-h-screen bg-[#F7F8FA] text-[#0B1020]">
        ...
        <FadeIn delay={80}>
          <div className="max-w-2xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            {[
              ...
              {
                href: '/bias', external: false,
                label: 'Daily Bias', sub: 'NQ & ES structure',
                color: '#7C3AED',
                icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-4 h-4"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>,
              },
              {
      ...
      <footer className="border-t border-gray-200/70 py-6 px-6">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <span className="text-xs text-slate-300 font-mono">jhptrades.com</span>
          <div className="flex items-center gap-5">
            <a href="mailto:christian.park2002@gmail.com"
              className="text-xs text-gray-400 hover:text-gray-600 transition-colors">
              christian.park2002@gmail.com
            </a>
            <Link href="/bias" className="text-xs text-gray-400 hover:text-gray-700 transition-colors">
              daily bias →
            </Link>
